                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    ...
                                    <form class="user" id="frmForgot">
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user"
                                                placeholder="Enter Email Address..." name="str_forgot_email" required>
                                        </div>
                                        <button class="btn btn-primary btn-user btn-block" type="submit" name="btnForgot">Reset Password</button>
                                        @csrf
                                        <hr>
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="{{ url('/loginuser') }}">Already have an
                                            account? Login!</a>
                                    </div>
                                </div>
                            </div>
